            ...
            for (q = 0; q < stage; q++)
            {
                for (p = 0; p < 8; p++)
                {
                    if (random[q] < 10) {
                        ...
                        printmatrix[p] += bomb[random[q - 10] - 1][p];
                    }
        ...
        if (nextmole == 1)
        {
            ...
            for (p2 = 0; p2 < 8; p2++)
            {
                if (renumber < 10) {
                    ...
                    printmatrix[p2] += bomb[renumber-11][p2];
                }
        ...
        for (z = 0; z < stage; z++)
        {
            ...
            if (random[z] > 10) {
                if (num == random[z] - 10)
                {
                    ...
                    for (x1 = 0; x1 < 8; x1++)
                    {
                        printmatrix[x1] = printmatrix[x1] - bomb[num-1][x1];
                    }
        ...
        for (timelimit = 0; timelimit < stage; timelimit++)
        {
            ...
            if (timeleft[timelimit] > stagetime)
            {
                ...
                if (random[timelimit] > 10) {
                    ...
                    for (x4 = 0; x4 < stage; x4++)
                    {
                        if (random[x4] > 10) {
                            if (renumber == random[x4] - 10) {
                                renumber = (rand() % 9) + 1;
                                x4--;
                            }
                        }
